...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (pageSlug) {
      // Use pageSlug directly - storage_path matches actual storage location
      // Do NOT prefix with 'media/' as this breaks the folder structure
      console.log('[upload-image] Using pageSlug:', pageSlug);
