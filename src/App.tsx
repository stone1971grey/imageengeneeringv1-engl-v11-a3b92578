  ...
  <QueryClientProvider client={queryClient}>
    <LanguageProvider>
      <TooltipProvider>
        ...
        <Route path="/styleguide" element={<DynamicCMSPage />} />
        <Route path="/styleguide/:category/:subcategory" element={<DynamicCMSPage />} />
        <Route path="/styleguide/:slug" element={<DynamicCMSPage />} />
