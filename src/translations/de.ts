export const de = {
  ...
  nav: {
    ...
    industries: "Branchen",
    products: "Produkte",
    resources: "Schulung & Veranstaltungen",
    about: "Info Hub",
    testServices: "Testlabor",
    automotive: "Automotive",
    securitySurveillance: "Sicherheit & Überwachung",
    mobilePhone: "Mobiltelefon",
    webCamera: "Webkamera",
    machineVision: "Maschinelles Sehen",
    medicalEndoscopy: "Medizin & Endoskopie",
    scannersArchiving: "Scanner & Archivierung",
    photoVideo: "Foto & Video",
    testCharts: "Testcharts",
    illuminationDevices: "Beleuchtungsgeräte",
    measurementDevices: "Messgeräte",
    softwareApis: "Software & APIs",
    productAccessories: "Produktzubehör",
    ...
    webinars: "Webinare",
    onSiteTraining: "Vor-Ort-Schulung",
    visitTestLab: "Besuchen Sie unser Testlabor",
    eventSchedule: "Veranstaltungskalender",
    viewTrainingEvents: "Schulung & Veranstaltungen ansehen",
    infoHub: "Info Hub",
    ...
    diplomaTheses: "Abschlussarbeiten",
    videoArchive: "Video-Archiv",
    exploreInfoHub: "Info Hub Ressourcen erkunden",
    aboutIE: "Über IE",
    team: "Team",
  ...
  // Standards Section
  standards: {
    title: "Gestaltung globaler Standards",
    subtitle: "Unsere Ingenieure beteiligen sich aktiv an der Entwicklung der wichtigsten internationalen Standards für Bildqualitätsprüfungen.",
    seeAllStandards: "Alle Standards anzeigen",
    hideStandards: "Standards ausblenden",
    supportedStandards: "Unterstützte Standards",
    basedOnStandards: "Unsere Testverfahren basieren auf international anerkannten Standards",
  ...
  // Automotive Page
  automotive: {
    title: "Automotive & ADAS-Tests",
    subtitle: "Umfassende Testlösungen für Automotive-Kamerasysteme und Fahrerassistenzsysteme",
    introduction: "Einführung",
    applications: "ADAS-Anwendungen",
    standards: "Standards & Tests",
    products: "Produkte",
    inCabinTitle: "Innenraum-Leistungstests",
    inCabinDesc: "Fahrer- und Insassenüberwachungssysteme (DMS/OMS) verwenden eine Vielzahl von Nahinfrarot-Sensoren (NIR) in Kombination mit aktiver Beleuchtung (z.B. LED), um die Sicherheit und den Komfort von Fahrern und Passagieren zu erhöhen.",
    adasTitle: "ADAS-Leistungstests",
    adasDesc: "Fahrerassistenzsysteme (ADAS) umfassen eine breite Palette von Kamera- und Sensorsystemen, die autonome Fahrzeugbewegungen unterstützen und Fahrerwarnsysteme bereitstellen.",
    geoCalTitle: "Geometrische Kamerakalibrierung",
    geoCalDesc: "Eine wesentliche Messung für ADAS-Anwendungen, die 3D-Objekte in einer bewegten Szene erkennen und genau abbilden müssen und Anpassungen basierend auf diesen Berechnungen vornehmen.",
    climateTitle: "Klimakontrollierte Tests",
    climateDesc: "Die Integration verschiedener Wetterszenarien in Automotive-Kameratests ist entscheidend, um zu verstehen, ob diese Systeme auch unter härtesten Wetterbedingungen ihre Leistungsschwellen erreichen können."
  },
  
  // News Page
  newsPage: {
    title: "Neueste Nachrichten & Updates",
    subtitle: "Bleiben Sie informiert über unsere neuesten Produkte, Technologien und Brancheneinblicke",
    readMore: "Mehr lesen"
  },
  ...
  whitepaper: {
    title: "Whitepapers",
    subtitle: "Technisches Fachwissen und Branchenkenntnisse für Ihre Projekte. Laden Sie unsere umfassenden Whitepapers herunter.",
    featured: "Empfohlen",
    pages: "Seiten",
    category: "Kategorie",
    downloadNow: "Jetzt herunterladen",
    learnMore: "Mehr erfahren",
    available: "Verfügbare Whitepapers",
    availableDesc: "Unsere Whitepapers bieten tiefgehende Einblicke in Testmethoden, Standards und Best Practices für Bildqualitätsmessungen.",
    formTitle: "Whitepaper-Download",
    formDesc: "Bitte füllen Sie das Formular aus, um herunterzuladen",
    name: "Name",
    email: "E-Mail",
    company: "Unternehmen",
    position: "Position",
    ...
    downloading: "Das Whitepaper wird heruntergeladen...",
    close: "Schließen",
  ...
  // Footer
  footer: {
    tagline: "Präzisions-Testgeräte für Bildqualität",
    products: "Produkte",
    testCharts: "Testcharts",
  ...
  contactPage: {
    heroTitle: "Lassen Sie uns erkunden, wie wir",
    heroTitleHighlight: "zusammenarbeiten können",
    heroDescription: "Ob Sie Testgeräte, Beratungsleistungen oder maßgeschneiderte Lösungen benötigen — unser Team von Bildgebungsexperten steht Ihnen zur Seite. Senden Sie eine Anfrage, vereinbaren Sie einen Termin, chatten Sie mit uns via WhatsApp oder abonnieren Sie unseren Newsletter.",
    submitInquiry: "Anfrage senden",
    submitInquiryDesc: "Kontaktieren Sie uns, fordern Sie Informationen an oder starten Sie ein Projekt.",
    leaveMessage: "Nachricht hinterlassen",
    replyTime: "Antwort innerhalb eines Werktags.",
    scheduleMeeting: "Termin vereinbaren",
    scheduleMeetingDesc: "Buchen Sie einen Videoanruf mit unseren Experten.",
    bookVideoMeeting: "Video-Meeting buchen",
    syncedAvailability: "Mit Verfügbarkeit synchronisiert.",
    chatWhatsApp: "Chat via WhatsApp",
    chatWhatsAppDesc: "Kurze Fragen? Erreichen Sie uns direkt über WhatsApp.",
    startChat: "Chat starten",
    availableBusinessHours: "Während der Geschäftszeiten erreichbar.",
    subscribeNewsletter: "Newsletter abonnieren",
    subscribeNewsletterDesc: "Erhalten Sie Updates zu neuen Produkten, Veranstaltungen und Fachthemen.",
    subscribeNow: "Jetzt abonnieren",
    chooseTopics: "Wählen Sie Ihre Interessengebiete.",
    headOfficeGermany: "Hauptsitz Deutschland",
    officeUSA: "Niederlassung USA",
    officeChina: "Niederlassung China",
    mondayFriday: "Montag-Freitag",
    saturdaySunday: "Samstag, Sonntag: nach Vereinbarung",
    phone: "Telefon",
    email: "E-Mail",
    thankYou: "Vielen Dank!",
    messageSent: "Ihre Nachricht wurde empfangen. Unser Team wird Ihre Anfrage prüfen und sich innerhalb eines Werktags bei Ihnen melden.",
    sendAnother: "Weitere Nachricht senden",
    name: "Name",
    yourName: "Ihr Name",
    emailAddress: "E-Mail",
    yourEmail: "ihre.email@firma.de",
    message: "Nachricht",
    ...
    consent: "Ich stimme der Verarbeitung meiner Daten gemäß der Datenschutzrichtlinie zu und möchte Informationen über Produkte und Dienstleistungen erhalten.",
    submit: "Absenden",
    submitting: "Wird gesendet...",
    newsletterTopics: "Themen auswählen",
    ...
    successSubscribed: "Erfolgreich abonniert!",
    successSubscribedDesc: "Sie erhalten Updates zu Ihren ausgewählten Themen.",
    errorSubscribing: "Fehler beim Abonnieren",
    errorSubscribingDesc: "Bitte versuchen Sie es später erneut.",
    messageSentSuccess: "Nachricht erfolgreich gesendet!",
    messageSentSuccessDesc: "Wir melden uns innerhalb eines Werktags bei Ihnen.",
    errorSending: "Fehler beim Senden",
    errorSendingDesc: "Bitte versuchen Sie es erneut oder kontaktieren Sie uns direkt.",
    // Dialog translations
    inquiryDialogTitle: "Anfrage senden",
    inquiryDialogDescription: "Erzählen Sie uns von Ihren Bedürfnissen und wir melden uns innerhalb eines Werktags bei Ihnen.",
    newsletterDialogTitle: "Newsletter abonnieren",
    newsletterDialogDescription: "Bleiben Sie auf dem Laufenden mit den neuesten Nachrichten zu Ihren Interessengebieten.",
    termsAndConditions: "AGB",
    privacyPolicy: "Datenschutzrichtlinie",
    inquiryConsentText: "Ich stimme der Verarbeitung meiner persönlichen Daten zu und akzeptiere die",
    newsletterConsentText: "Ich stimme dem Erhalt von Newsletter-E-Mails zu und akzeptiere die",
    sending: "Wird gesendet...",
    // Interest options
    interestProducts: "Produkte & Ausrüstung",
    interestTestlab: "Testlabor-Dienste",
    interestConsulting: "Beratung",
    interestTraining: "Schulung & Veranstaltungen",
    interestSoftware: "Softwarelösungen",
    interestCustom: "Maßgeschneiderte Projekte",
    // Newsletter topics
    topicProductUpdates: "Produktneuheiten",
    topicIndustryNews: "Branchennachrichten",
    topicStandards: "Standards & Vorschriften",
    topicEvents: "Events & Webinare",
    topicTechnical: "Fachartikel",
    topicCaseStudies: "Fallstudien"
  }
};
