...
const translations: Record<Language, any> = {
  en: {
    ...
    automotive: {
      hero: {
        ...
        description: "Precision-engineered camera system test solutions for robust vehicle safety, performance and autonomy.",
        cta: "Discover Automotive Solutions",
        stat1: "Accuracy",
        stat2: "Response",
        stat3: "ADAS Projects",
        liveProcessing: "Live Processing",
        adasComponent: "ADAS Component"
      },
      applications: {
        title: "Main Applications",
        description: "Automotive camera systems cover a broad spectrum of applications that contribute to vehicle safety, comfort and performance.",
        inCabin: {
      ...
      standards: {
        title: "Automotive International Standards",
        description: "A look at the crucial industry standards for automotive image quality performance testing and evaluation.",
        ieee: {
          title: "IEEE-P2020",
          description: "The first internationally recognized standard examines the factors contributing to the image quality of Advanced Driver Assistance Systems (ADAS) and outlines various test methods and tools."
        },
        emva: {
          title: "EMVA 1288/ISO 24942",
          description: "EMVA 1288/ISO 24942 (same standard metrics) outlines threshold specifications and measurement methods for machine vision cameras, many of which are commonly used in automotive vehicles."
        },
        iso: {
          title: "ISO 19093",
          description: "ISO 19093 outlines measurement methods and metric thresholds for evaluating the performance of a camera system under various low-light conditions."
        },
        learnMore: "Learn More"
      },
      solutions: {
        title: "Automotive Camera Test Solutions",
        description: "We offer a wide range of test solutions for all of the most crucial automotive camera applications and performance metrics.",
        inCabin: {
          title: "In-Cabin Testing",
          paragraph1: "In-Cabin systems are primarily tasked with observing the comfort and safety of the driver and passengers. These systems typically work with NIR (near-infrared) sensors combined with active illumination (e.g., LED or VCSEL) to ensure accuracy in very low-light conditions.",
      ...
      testLab: {
        title: "Automotive Camera Test Services",
        paragraph1: "Welcome to our iQ-Lab, one of the world's largest independent camera test labs. We offer a wide range of tests for the automotive industry, including the camPAS (Camera Performance for Automotive Systems) test.",
        paragraph2: "The camPAS test was developed for clients who need independent and objective test results from a neutral third-party to support their development decisions. camPAS, like most of our testing services, can be tailored to meet your specific KPI requirements. Don't hesitate to reach out to our iQ-Lab team to discuss your requirements and all of our test services."
      }
    },
    footer: {
  ...
  de: {
    ...
    automotive: {
      hero: {
        title: "Automotive",
        subtitle: "Bildqualität",
        description: "Präzisionsentwickelte Kamerasystem-Testlösungen für robuste Fahrzeugsicherheit, Leistung und Autonomie.",
        cta: "Automotive-Lösungen entdecken",
        stat1: "Genauigkeit",
        stat2: "Reaktion",
        stat3: "ADAS-Projekte",
        liveProcessing: "Live-Verarbeitung",
        adasComponent: "ADAS-Komponente"
      },
      applications: {
        title: "Hauptanwendungen",
        description: "Automotive-Kamerasysteme decken ein breites Spektrum von Anwendungen ab, die zur Fahrzeugsicherheit, zum Komfort und zur Leistung beitragen.",
        inCabin: {
          title: "In-Cabin-Leistungstests",
          description: "Fahrer- und Insassenüberwachungssysteme (DMS/OMS) verwenden eine Vielzahl von Nahinfrarot-Sensoren (NIR) in Kombination mit aktiver Beleuchtung (z. B. LED), um die Sicherheit und den Komfort von Fahrern und Passagieren zu verbessern."
        },
        adas: {
          title: "ADAS-Leistungstests",
          description: "Fortschrittliche Fahrerassistenzsysteme (ADAS) umfassen eine breite Palette von Kamera- und Sensorsystemen, die autonome Fahrzeugbewegungen unterstützen und Fahrerwarnungen bereitstellen."
        },
        geometric: {
          title: "Geometrische Kamerakalibrierung",
          description: "Eine wesentliche Messung für ADAS-Anwendungen, die 3D-Objekte in einer sich bewegenden Szene erkennen und genau abbilden und auf der Grundlage dieser Berechnungen Anpassungen vornehmen müssen."
        },
        climate: {
          title: "Klimakontrollierte Tests",
          description: "Die Integration verschiedener Wetterszenarien in Automotive-Kameratests ist entscheidend, um zu verstehen, ob diese Systeme auch unter härtesten Wetterbedingungen ihre Leistungsschwellen erfüllen können."
        },
        learnMore: "Mehr erfahren"
      },
      standards: {
        title: "Internationale Automotive-Standards",
        description: "Ein Blick auf die wichtigsten Industriestandards für Automotive-Bildqualitätsleistungstests und -bewertung.",
        ieee: {
          title: "IEEE-P2020",
          description: "Der erste international anerkannte Standard untersucht die Faktoren, die zur Bildqualität von Advanced Driver Assistance Systems (ADAS) beitragen, und beschreibt verschiedene Testmethoden und -werkzeuge."
        },
        emva: {
          title: "EMVA 1288/ISO 24942",
          description: "EMVA 1288/ISO 24942 (gleiche Standardmetriken) beschreibt Schwellenspezifikationen und Messmethoden für Machine-Vision-Kameras, von denen viele häufig in Kraftfahrzeugen verwendet werden."
        },
        iso: {
          title: "ISO 19093",
          description: "ISO 19093 beschreibt Messmethoden und metrische Schwellenwerte zur Bewertung der Leistung eines Kamerasystems unter verschiedenen Schwachlichtbedingungen."
        },
        learnMore: "Mehr erfahren"
      },
      solutions: {
        title: "Automotive-Kamera-Testlösungen",
        description: "Wir bieten eine breite Palette von Testlösungen für alle wichtigsten Automotive-Kameraanwendungen und Leistungsmetriken.",
        inCabin: {
          title: "In-Cabin-Tests",
          paragraph1: "In-Cabin-Systeme haben in erster Linie die Aufgabe, den Komfort und die Sicherheit des Fahrers und der Passagiere zu überwachen. Diese Systeme arbeiten typischerweise mit NIR-Sensoren (Nahinfrarot) in Kombination mit aktiver Beleuchtung (z. B. LED oder VCSEL), um Genauigkeit bei sehr geringen Lichtverhältnissen zu gewährleisten.",
          paragraph2: "Wir bieten eine breite Palette von Testlösungen mit IR-Fähigkeiten an, darunter die LE7 VIS-IR Uniform-Lightbox, die iQ-LED-Technologie verwendet und es Ihnen ermöglicht, benutzerdefinierte Spektren zwischen 380 – 1050 nm zu erzeugen. Die LE7 kann mit transparenten Testcharts wie der camSPECS-Platte IR verwendet werden, die für Farbkalibrierungen und die Messung spektraler Empfindlichkeiten im NIR-Bereich optimiert ist."
        },
        adas: {
          title: "ADAS-Leistungstests",
          paragraph1: "Fortschrittliche Fahrerassistenzsysteme (ADAS) beziehen sich auf die Kamera- und Sensorsysteme, die Fahrer bei verschiedenen Bewegungsanpassungen und Sicherheitswarnungen unterstützen. Diese Systeme erfordern eine breite Palette von Testmethoden und Metriken zur Bewertung, um hohe Leistung und Sicherheit zu gewährleisten. Unsere Testlösungen folgen eng den Testmethodenrichtlinien, die im IEEE-P2020-Standard für die ADAS-Bildqualitätsleistung festgelegt sind.",
          paragraph2: "Einige der im P2020-Standard beschriebenen wichtigsten Leistungsindikatoren (KPIs) umfassen Kontrastindikatoren – Kontrastübertragungsgenauigkeit (CTA) und Kontrast-Signal-Rausch-Verhältnis (CSNR) –, Dynamikbereich und Flicker-Reaktion. Diese KPIs erfordern leistungsstarke Lichtquellen, die die hohen Intensitäten simulieren können, die ADAS-Systeme erfahren. Wir bieten mehrere Lichtquellen an, darunter Vega und Arcturus, die dynamische Testszenen mit extrem hoher Stabilität und Konsistenz erzeugen können."
        },
        geometric: {
          title: "Geometrische Kalibrierung",
          paragraph1: "Geometrische Kalibrierung bezieht sich auf die Fähigkeit einer Kamera, 3D-Objekte in einer sich bewegenden Szene zu erkennen und genau abzubilden. In Automotive-Anwendungen werden Entfernungen zu Objekten basierend auf den gemessenen geometrischen Eigenschaften der Kamera oder eines Stereo-Kamerapaars berechnet. Eine ordnungsgemäße geometrische Kalibrierung von Automotive-Kamerasystemen ist unerlässlich, um hohe Leistung und Sicherheit zu gewährleisten.",
          paragraph2: "Traditionelle geometrische Kalibrierungsmethoden erfordern in der Regel viel Laborraum in Kombination mit zahlreichen Verzerrungstestzielen und Relaislinsen. Während diese Methoden funktional sind, sind sie für die meisten Testlabore, die keinen Platz haben, nicht sehr praktikabel. Um dieser Herausforderung zu begegnen, bieten wir die GEOCAL-Lösung an. GEOCAL ist ein kompaktes Gerät, das einen strahlerweiterten Laser und ein diffraktives optisches Element (DOE) verwendet, um ein Raster von Lichtpunkten zu erzeugen, die aus der Unendlichkeit stammen. Diese Funktionen machen mehrere Testziele und Relaislinsen überflüssig und machen sie für den Einsatz in Laboren jeder Größe geeignet."
        },
        climate: {
          title: "Klimakontrollierte Tests",
          paragraph1: "Eine der grundlegenden Anforderungen von ADAS-Anwendungen ist ihre Fähigkeit, unter allen Wetterszenarien ordnungsgemäß zu funktionieren. Wenn diese Systeme ihre Mindestleistungsschwellenanforderungen aufgrund von Bedingungen wie dichtem Nebel oder starkem Regen nicht erfüllen, könnte die Sicherheit beeinträchtigt werden. Daher ist das Testen von ADAS-Anwendungen in wechselnden Wetterumgebungen unerlässlich.",
          paragraph2: "Um Wettertests durchzuführen, fahren viele Unternehmen Testfahrzeuge unter verschiedenen Wetterbedingungen und zeichnen die Kameraleistung auf. Diese Tests sind zwar im realen Sinne genau, es fehlt ihnen jedoch in der Regel an Wiederholbarkeit und extremen Bedingungen (z. B. extreme Kälte oder Hitze) aufgrund der Unvorhersehbarkeit des Wetters und der Teststandorte. Um diese Herausforderungen zu bewältigen, bieten wir die iQ-Climate Chamber-Lösung an, mit der Sie ein Kamerasystem unter extremen Wetterbedingungen im Komfort eines Testlabors testen können."
        }
      },
      products: {
        title: "Hauptprodukte",
        description: "Branchenführende Werkzeuge für Automotive-Bildqualitätsleistungstests",
        arcturus: {
          title: "Arcturus",
          description: "Eine hochintensive Lichtquelle mit unübertroffener Stabilität und Konsistenz."
        },
        le7: {
          title: "LE7 VIS-IR",
          description: "Eine gleichmäßige Lichtquelle zum Testen von Kameras im Nahinfrarotbereich (NIR)."
        },
        geocal: {
          title: "GEOCAL",
          description: "Geometrische Kalibrierungen mit einem kompakten Gerät, das ein Raster von Lichtpunkten erzeugt, die aus der Unendlichkeit stammen."
        },
        climate: {
          title: "iQ-Climate Chamber",
          description: "Temperaturkontrollierte Kameratests im Komfort eines Kameratestlabors."
        },
        te292: {
          title: "TE292 VIS-IR",
          description: "Ein Testchart für spektrale Empfindlichkeitsmessungen und Farbkalibrierungen im VIS-IR-Bereich."
        },
        analyzer: {
          title: "iQ-Analyzer-X",
          description: "Erweiterte Software zur Bewertung der Leistung verschiedener Bildqualitätsfaktoren."
        },
        learnMore: "Mehr erfahren",
        active: "AKTIV",
        clickable: "KLICKBAR"
      ...
      testLab: {
        title: "Automotive-Kamera-Testdienste",
        paragraph1: "Willkommen in unserem iQ-Lab, einem der weltweit größten unabhängigen Kameratestlabore. Wir bieten eine breite Palette von Tests für die Automobilindustrie an, einschließlich des camPAS-Tests (Camera Performance for Automotive Systems).",
        paragraph2: "Der camPAS-Test wurde für Kunden entwickelt, die unabhängige und objektive Testergebnisse von einem neutralen Dritten benötigen, um ihre Entwicklungsentscheidungen zu unterstützen. camPAS kann, wie die meisten unserer Testdienste, an Ihre spezifischen KPI-Anforderungen angepasst werden. Zögern Sie nicht, unser iQ-Lab-Team zu kontaktieren, um Ihre Anforderungen und alle unsere Testdienste zu besprechen."
      }
    },
    footer: {
