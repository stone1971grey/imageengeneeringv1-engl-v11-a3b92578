  ...
  en: {
    ...
    automotive: {
      hero: {
        ...
        stat2Label: 'Response',
        stat3Value: '100+',
        stat3Label: 'ADAS Projects'
      },
      applications: {
        title: 'Main Applications',
        subtitle: 'Automotive camera systems cover a broad spectrum of applications that contribute to vehicle safety, comfort and performance.',
        inCabin: {
      ...
      standards: {
        ...
        subtitle: 'A look at the crucial industry standards for automotive image quality performance testing and evaluation.',
        ieee: {
          title: 'IEEE-P2020',
      ...
      solutions: {
        ...
        subtitle: 'We offer a wide range of test solutions for all of the most crucial automotive camera applications and performance metrics.',
        inCabin: {
      ...
      products: {
        title: 'Key Products',
        subtitle: 'Industry-leading tools for automotive image quality performance testing',
        arcturus: {
          title: 'Arcturus',
  ...
  zh: {
    ...
    automotive: {
      hero: {
        title: '汽车',
        subtitle: '图像质量',
        description: '用于稳健车辆安全、性能和自主性的精密工程相机系统测试解决方案。',
        cta: '探索汽车解决方案',
        stat1Value: '99.9%',
        stat1Label: '准确度',
        stat2Value: '50ms',
      ...
      applications: {
        ...
        inCabin: {
          title: '车内性能测试',
          description: '驾驶员和乘员监控系统（DMS/OMS）使用各种近红外（NIR）传感器结合主动照明（例如LED）来增强驾驶员和乘客的安全性和舒适性。'
        },
        adas: {
          title: 'ADAS性能测试',
          description: '高级驾驶辅助系统（ADAS）包括广泛的相机和传感器系统，支持自主车辆运动并提供驾驶员警告通知。'
        },
        geometric: {
          title: '几何相机校准',
          description: 'ADAS应用的基本测量，需要检测并准确映射移动场景中的3D对象，并根据这些计算进行调整。'
        },
        climate: {
          title: '气候控制测试',
          description: '将各种天气场景纳入汽车相机测试对于了解这些系统是否仍能在最恶劣的天气条件下达到其性能阈值至关重要。'
        },
        learnMore: '了解更多'
      },
      standards: {
        title: '汽车国际标准',
        subtitle: '了解汽车图像质量性能测试和评估的关键行业标准。',
        ieee: {
          title: 'IEEE-P2020',
          description: '第一个国际公认的标准，检查有助于高级驾驶辅助系统（ADAS）图像质量的因素，并概述各种测试方法和工具。'
        },
        emva: {
          title: 'EMVA 1288/ISO 24942',
          description: 'EMVA 1288/ISO 24942（相同的标准指标）概述了机器视觉相机的阈值规范和测量方法，其中许多常用于汽车车辆。'
        },
        iso: {
          title: 'ISO 19093',
          description: 'ISO 19093概述了在各种低光条件下评估相机系统性能的测量方法和度量阈值。'
        },
        learnMore: '了解更多'
      },
      solutions: {
        ...
        inCabin: {
          title: '车内测试',
          paragraph1: '车内系统主要负责观察驾驶员和乘客的舒适度和安全性。这些系统通常与NIR（近红外）传感器结合主动照明（例如LED或VCSEL）一起工作，以确保在极低光条件下的准确性。',
          paragraph2: '我们提供广泛的具有IR功能的测试解决方案，包括LE7 VIS-IR均匀光箱，它使用iQ-LED技术，允许您在380-1050 nm之间生成自定义光谱。LE7可以与透明测试图表（如camSPECS板IR）一起使用，该图表针对NIR范围内的颜色校准和测量光谱灵敏度进行了优化。'
        },
        adas: {
          title: 'ADAS性能测试',
          paragraph1: '高级驾驶辅助系统（ADAS）是指协助驾驶员进行各种运动调整和安全警告的相机和传感器系统。这些系统需要广泛的测试方法和指标来评估，以确保高性能和安全性。我们的测试解决方案严格遵循IEEE-P2020标准中建立的ADAS图像质量性能测试方法指南。',
          paragraph2: 'P2020标准中概述的一些关键性能指标（KPI）包括对比度指标——对比度传输准确性（CTA）和对比度信噪比（CSNR）——动态范围和闪烁响应。这些KPI需要强大的光源，可以模拟ADAS系统所经历的高强度。我们提供多种光源，包括Vega和Arcturus，可以生成具有极高稳定性和一致性的动态测试场景。'
        },
        geometric: {
          title: '几何校准',
          paragraph1: '几何校准是指相机检测并准确映射移动场景中3D对象的能力。在汽车应用中，基于相机或立体相机对的测量几何特性计算到对象的距离。适当的汽车相机系统几何校准对于确保高性能和安全性至关重要。',
          paragraph2: '传统的几何校准方法通常需要大量的实验室空间，结合众多畸变测试目标和中继透镜。虽然这些方法是功能性的，但对于大多数没有空间的测试实验室来说并不实用。为了应对这一挑战，我们提供GEOCAL解决方案。GEOCAL是一个紧凑的设备，使用光束扩展激光和衍射光学元件（DOE）生成从无穷远处发出的光点网格。这些功能消除了对多个测试目标和中继透镜的需求，使其适用于任何尺寸的实验室。'
        },
        climate: {
          title: '气候控制测试',
          paragraph1: 'ADAS应用的基本要求之一是它们在任何天气场景中正常运行的能力。如果这些系统由于浓雾或倾盆大雨等条件而无法满足其最低性能阈值要求，则可能会危及安全。因此，在不断变化的天气环境中测试ADAS应用至关重要。',
          paragraph2: '为了进行天气测试，许多公司在各种天气条件下驾驶测试车辆并记录相机性能。然而，虽然在现实世界意义上准确，但由于天气和测试地点的不可预测性，这些测试通常缺乏可重复性和极端条件（例如极冷或极热）。为了应对这些挑战，我们提供iQ-Climate Chamber解决方案，允许您在测试实验室的舒适环境中在极端天气条件下测试相机系统。'
        }
      },
      products: {
        title: '关键产品',
        subtitle: '用于汽车图像质量性能测试的行业领先工具',
        arcturus: {
          title: 'Arcturus',
        ...
        le7: {
          title: 'LE7 VIS-IR',
          description: '用于在近红外（NIR）范围内测试相机的均匀光源。'
        },
        geocal: {
          title: 'GEOCAL',
          description: '使用紧凑设备进行几何校准，该设备生成从无穷远处发出的光点网格。'
        },
        climate: {
          title: 'iQ-Climate Chamber',
        ...
        te292: {
          title: 'TE292 VIS-IR',
          description: '用于VIS-IR范围内光谱灵敏度测量和颜色校准的测试图表。'
        },
        iqAnalyzer: {
          title: 'iQ-Analyzer-X',
      ...
      testLab: {
        title: '汽车相机测试服务',
        paragraph1: '欢迎来到我们的iQ-Lab，世界上最大的独立相机测试实验室之一。我们为汽车行业提供广泛的测试，包括camPAS（汽车系统相机性能）测试。',
        paragraph2: 'camPAS测试是为需要来自中立第三方的独立和客观测试结果以支持其开发决策的客户开发的。camPAS与我们的大多数测试服务一样，可以根据您的特定KPI要求进行定制。请随时与我们的iQ-Lab团队联系，讨论您的要求和我们的所有测试服务。'
      }
    },
    productArcturus: {
      hero: {
        title: 'Arcturus LED系统',
        subtitle: '高强度照明，无与伦比的稳定性',
        description: 'Arcturus是一个先进的LED照明系统，专为需要高亮度和卓越稳定性的汽车相机测试而设计。',
        cta: '请求产品演示'
      },
      benefits: {
        title: '主要优势',
        brightness: {
          title: '高亮度',
          description: '高达100,000勒克斯的强大照明，适用于ADAS测试'
        },
        stability: {
          title: '卓越稳定性',
          description: '行业领先的光输出一致性和稳定性'
        },
        spectral: {
          title: '光谱一致性',
          description: '精确的颜色再现和光谱稳定性'
        },
        dynamic: {
          title: '动态范围',
          description: '卓越的HDR和低光测试能力'
        },
        ieee: {
          title: 'IEEE P2020',
          description: '完全符合汽车测试标准'
        },
        control: {
          title: '精确控制',
          description: '具有先进软件控制的完整测试场景'
        }
      },
      video: {
        title: 'Arcturus实际演示'
      ...
      useCase: {
        title: '主要用例',
        subtitle: '模拟明亮阳光',
        description: 'Arcturus设计用于在实验室条件下模拟明亮阳光。这对于测试汽车相机在高光条件下的性能至关重要。'
      },
      specs: {
        title: '技术规格',
        model: '型号',
      ...
      software: {
        ...
        vega: {
          title: 'Vega软件套件',
          description: 'Arcturus由我们先进的Vega软件套件控制，该套件为测试场景创建、自动化和结果分析提供完整工具。'
        }
      },
      standards: {
        title: '标准合规性与关键性能指标',
        subtitle: 'Arcturus支持所有主要的汽车图像质量标准',
        supported: '支持的标准'
      },
      comparison: {
        title: '产品比较',
      ...
      applications: {
        ...
        adas: {
          title: 'ADAS测试',
          description: '在高光条件下进行高级驾驶辅助系统测试'
        },
        hdr: {
          title: 'HDR性能',
          description: '测试高动态范围相机性能'
        },
        flicker: {
          title: '闪烁测试',
          description: 'LED和显示闪烁分析'
        },
        validation: {
          title: '生产验证',
          description: '质量控制和生产线测试'
        }
      },
      gallery: {
        title: '产品图库',
      ...
      installation: {
        title: '典型实验室安装',
        description: '展示典型汽车测试实验室中的Arcturus系统'
      },
      downloads: {
        title: '相关下载',
        datasheet: {
          title: 'Arcturus数据表',
          description: '完整的技术规格和性能数据'
        },
        controller: {
          title: 'Arcturus控制器数据表',
          description: '控制系统技术详情'
        },
        download: '下载PDF'
      }
    },
    productLE7: {
      hero: {
        title: 'LE7 VIS-IR LED系统',
        subtitle: '可见光和红外照明的精密测试',
        description: '配备iQ-LED技术的先进可见光和近红外照明系统，用于车内和ADAS相机测试。',
        cta: '请求产品演示'
      },
      overview: {
        title: '产品概述',
        description: 'LE7 VIS-IR是一个先进的均匀光源，专为测试可见光（VIS）和近红外（NIR）光谱范围内的相机系统而设计。它使用我们专有的iQ-LED技术，允许在380-1050 nm之间创建自定义光谱分布。这使其成为车内监控系统、夜视相机和其他需要近红外照明的应用的理想选择。'
      },
      standards: {
        title: '国际标准与认证',
        subtitle: '符合所有主要汽车和图像质量标准',
        ieee: {
          title: 'IEEE P2020',
          description: 'ADAS图像质量性能标准'
        },
        emva: {
          title: 'EMVA 1288',
          description: '机器视觉相机表征'
        },
        iso: {
          title: 'ISO 19093',
          description: '低光性能测试'
        },
        exploreStandards: '探索标准',
        downloadCompliance: '下载合规性文档'
      },
      benefits: {
        title: '主要优势',
        spectral: {
          title: '可定制光谱',
          description: '在380-1050 nm之间创建任何光谱分布'
        },
        uniformity: {
          title: '高均匀性',
          description: '测试区域内的卓越光均匀性'
        },
        stability: {
          title: '长期稳定性',
          description: '一致的性能和可靠的测量'
        },
        control: {
          title: '精确控制',
          description: '通过软件控制强度和光谱'
        }
      },
      useCases: {
        title: '用例',
        inCabin: {
          title: '车内监控',
          description: '使用NIR照明测试驾驶员和乘客监控系统（DMS/OMS）'
        },
        spectral: {
          title: '光谱灵敏度',
          description: '测量VIS和NIR范围内的相机光谱响应'
        }
      },
      specs: {
        title: '技术规格',
    ...
    charts: {
      hero: {
        title: '测试图表',
        subtitle: '专业图像质量分析',
        description: '探索我们广泛的高精度测试图表系列，专为全面的图像质量评估而设计。',
        search: '搜索图表...'
      },
      filters: {
        title: '过滤图表',
      ...
      noResults: {
        title: '未找到图表',
        description: '没有图表与您的过滤器匹配。请尝试调整搜索条件。',
        reset: '重置过滤器'
      },
      contact: {
        title: '需要帮助选择正确的图表吗？',
        description: '我们的专家可以帮助您为您的特定应用找到完美的测试图表。',
        button: '联系专家'
      }
    },
    events: {
    ...
    downloads: {
      ...
      results: {
        showing: '结果',
        noResults: '当前选择未找到匹配项。',
        reset: '重置过滤器'
      },
      ai: {
        title: 'AI助手',
        subtitle: '让我们帮助您快速轻松地找到正确的下载',
        description: '我们的智能助手可以帮助您在下载中心准确找到所需内容。',
        needHelp: '需要帮助吗？',
        ask: '询问我们的AI助手'
      },
      details: {
