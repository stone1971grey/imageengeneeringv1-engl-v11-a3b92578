...
// Web Camera landing page component
const WebCamera = () => {
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                {content.applications_description || "Web camera systems require precise image quality testing."}
              </p>
            </div>
          </div>
      ...
      return (
        <section key="solutions" id="solutions" className="py-20 bg-gray-50">
          <div className="w-full px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {solutionsTitle || "Web Camera Solutions"}
              </h2>
              {solutionsSubtext && (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* MANDATORY: Meta Navigation - Always Rendered First (Below Nav Bar) */}
      {tabOrder
        .filter(segmentId => {
          const dynamicSegment = pageSegments.find(seg => seg.id === segmentId);
            ...
            <div className={`space-y-8 ${
              ...
              <div>
                ...
                <p className="text-xl lg:text-2xl text-black font-light leading-relaxed max-w-lg">
                  {content.hero_description || "Precision testing solutions for web camera systems."}
                </p>
              </div>
              ...
              <div className="pt-4">
                {heroCtaLink.startsWith('http://') || heroCtaLink.startsWith('https://') ? (
                  ...
                  >
                    ...
                    >
                      {content.hero_cta || "Discover Web Camera Solutions"}
                    </Button>
                  </a>
                ) : (
                  <Link to={heroCtaLink}>
