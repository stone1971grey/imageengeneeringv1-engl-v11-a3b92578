...
// IEEE P2020 Standard page component
const ProductIEEEP2020 = () => {
    ...
    if (!error && data) {
      ...
      data.forEach((item: any) => {
        if (item.section_key === "page_segments") {
          ...
          setBannerButtonStyle(item.content_value);
  ...
  const renderSegment = (segmentId: string) => {
                ...
                <div className="flex justify-center">
                  {dynamicSegment.data.buttonLink ? (
                    dynamicSegment.data.buttonLink.startsWith('http://') || dynamicSegment.data.buttonLink.startsWith('https://') ? (
                      ...
                      <Link
                        to={dynamicSegment.data.buttonLink}
                        className="inline-block px-8 py-4 rounded-md text-lg font-medium transition-all duration-300 hover:scale-105"
                        style={{
                          backgroundColor: dynamicSegment.data.buttonStyle === "technical" ? "#1f2937" : "#f9dc24",
                          color: dynamicSegment.data.buttonStyle === "technical" ? "#ffffff" : "#000000"
    ...
    // Static segments (hero, tiles, banner, solutions)
    if (segmentId === 'hero') {
        ...
        <section key={segmentId} id={segmentIdMap['hero']?.toString() || 'hero'} className={`relative ${heroData.hero_top_padding === 'none' ? 'pt-16' : heroData.hero_top_padding === 'small' ? 'pt-24' : heroData.hero_top_padding === 'large' ? 'pt-32' : 'pt-28'} md:${heroData.hero_top_padding === 'none' ? 'pt-20' : heroData.hero_top_padding === 'small' ? 'pt-28' : heroData.hero_top_padding === 'large' ? 'pt-40' : 'pt-32'} pb-16 bg-gray-50`}>
          <div className="container mx-auto px-6">
            <div className={`grid gap-12 items-center ${
              ...
              heroData.hero_layout === '5-2' ? 'md:grid-cols-7' :
              heroData.hero_layout === '3-2' ? 'md:grid-cols-5' :
              'md:grid-cols-7'
            } ${heroData.hero_image_position === 'left' ? 'md:flex-row-reverse' : ''}`}>
              <div className={`${
                heroData.hero_layout === '1-1' ? '' :
                heroData.hero_layout === '5-2' ? 'md:col-span-5' :
                heroData.hero_layout === '3-2' ? 'md:col-span-3' :
                'md:col-span-2'
              }`}>
                ...
                {heroData.hero_cta && (
                  <div className="flex flex-wrap gap-4">
                    {heroData.hero_cta_link.startsWith('http://') || heroData.hero_cta_link.startsWith('https://') ? (
                      <a
                        ...
                        className="inline-block px-8 py-4 rounded-md text-lg font-medium transition-all duration-300 hover:scale-105"
                        style={{
                          backgroundColor: heroData.hero_cta_style === "technical" ? "#1f2937" : "#f9dc24",
                          color: heroData.hero_cta_style === "technical" ? "#ffffff" : "#000000"
                        }}
                      >
                        {heroData.hero_cta}
                      </a>
              ...
              {heroData.hero_image_url && (
                <div className={`${
                  heroData.hero_layout === '1-1' ? '' :
                  heroData.hero_layout === '5-2' ? 'md:col-span-2' :
                  heroData.hero_layout === '3-2' ? 'md:col-span-2' :
                  'md:col-span-5'
                }`}>
                  <img
...
export default ProductIEEEP2020;
