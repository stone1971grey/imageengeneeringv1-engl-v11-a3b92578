                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleInputChange('subject', value)} required>
                      <SelectTrigger className="h-12 text-base bg-[#f5743a] text-white border-0 rounded-md focus:ring-2 focus:ring-primary font-medium hover:bg-[#f5743a]/90 px-1 py-1">
