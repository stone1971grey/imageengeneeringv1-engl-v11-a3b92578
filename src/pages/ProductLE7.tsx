...
// LE7 Product Page with CMS functionality
const ProductLE7 = () => {
            ...
            <div className={`space-y-8 ${
              ...
              <div>
                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-light leading-[0.9] tracking-tight mb-6 text-black mt-8 md:mt-0">
                  {content.hero_title || "LE7"}
                  <br />
                  <span className="font-medium text-black">{content.hero_subtitle || "Illumination System"}</span>
                </h1>
                
                <p className="text-xl lg:text-2xl text-black font-light leading-relaxed max-w-lg">
                  {content.hero_description || "Professional illumination system for image quality testing."}
                </p>
              </div>
