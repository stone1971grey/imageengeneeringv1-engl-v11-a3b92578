            ...
            <div className="max-w-4xl mx-auto">
              ...
              <section id="colors" className="mb-16 scroll-mt-[320px]">
                ...
                <div className="grid gap-8">
                  ...
                  <div className="flex items-center gap-6 p-6 border border-gray-200 rounded-lg">
                    <div className="w-32">
                      <p className="font-medium text-gray-900">Medium Blue</p>
                      <p className="text-sm text-gray-500">Professional color</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <div 
                        className="w-16 h-16 rounded-lg border border-gray-300 shadow-sm" 
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Medium blue tone</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 p-6 border border-gray-200 rounded-lg">
                    <div className="w-32">
                      <p className="font-medium text-gray-900">Neutral Gray</p>
                      <p className="text-sm text-gray-500">Base color</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <div 
                        className="w-16 h-16 rounded-lg border border-gray-300 shadow-sm" 
