  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-[140px]">
                    ...
                    <div className="flex items-center gap-6 p-6 border border-gray-200 rounded-lg">
                     ...
                     <div className="flex items-center gap-6 p-6 border border-gray-200 rounded-lg">
                       <div className="w-32">
                         ...
                         <p className="text-xs text-gray-400 font-mono">#dfd848</p>
                       </div>
                     ...
                     <div className="flex items-center gap-6 p-6 border border-gray-200 rounded-lg">
                       <div className="w-32">
                         ...
                         <p className="text-xs text-gray-400 font-mono">#1d3e78</p>
                       </div>
        ...
        {/* Tiles Section - Full Width Outside Container */}
        <section id="tiles" className="mb-16">
          <div className="container mx-auto px-6 mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Tiles</h2>
          </div>
          
          {/* 4-Tile Layout - Main Applications */}
          <div className="mb-16">
            <div className="container mx-auto px-6 mb-8">
              <h3 className="text-2xl font-semibold text-gray-900">4-Tile Layout (Main Applications)</h3>
            </div>
