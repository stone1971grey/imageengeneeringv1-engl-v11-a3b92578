        ...
        <CardContent className="px-8 py-10 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-slate-600 leading-relaxed">
              Thank you for your interest in our video content. We're excited to share this comprehensive resource with you.
            </p>
          </div>
            ...
            <div className="text-center space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600">
                  Click the button below to watch your requested video
                </p>
              </div>
          ...
          <div className="pt-6 border-t border-slate-200">
            <div className="border-l-4 p-4 rounded-r-lg" style={{ backgroundColor: '#f3f3f5', borderLeftColor: '#f5743a' }}>
              <p className="text-sm text-slate-700 leading-relaxed">
                <span className="font-semibold text-slate-900">Stay Connected:</span> We'd be delighted to keep you informed about our latest videos, upcoming events, new products, and industry insights in automotive imaging and camera testing technology.
              </p>
            </div>
          </div>
