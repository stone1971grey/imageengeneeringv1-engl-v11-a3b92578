      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-24 lg:py-32">
          <div className="text-center max-w-5xl mx-auto -mt-[50px]">
            ...
            {/* Main Headline */}
            <div className="mb-8">
              <h1 id="industries-hero" className="text-5xl lg:text-6xl xl:text-7xl font-light text-white leading-[0.9] tracking-tight mb-6 pt-20 md:pt-0">
                Precision Solutions
                <br />
              ...
              <p className="text-xl lg:text-2xl text-white/90 font-light leading-relaxed max-w-3xl mx-auto">
                From vehicle safety to medical diagnostics - our advanced image processing technologies 
                drive innovation across various sectors worldwide.
              </p>
            </div>
