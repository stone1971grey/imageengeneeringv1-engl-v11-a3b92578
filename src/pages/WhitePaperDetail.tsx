            ...
            <CardContent className="px-8 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 pb-8 border-b border-slate-200">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">45 Pages</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">Automotive Standards</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Key Topics Covered</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">About IEEE P2020</h3>
