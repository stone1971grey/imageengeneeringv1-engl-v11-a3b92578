        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {newsItems.map((item) => (
                <Card key={item.id} className="h-full hover:shadow-elegant transition-all duration-300 hover:scale-[1.02] group bg-white border border-gray-200">
                  <CardContent className="p-0">
                    ...
                    <div className="p-6">
                      ...
                      <Button 
                        variant="outline" 
                        className="w-full group-hover:bg-[#103e7c] group-hover:text-white transition-colors duration-300"
                      >
                        Read more
                      </Button>
                    </div>
