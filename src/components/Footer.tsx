...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="bg-background/30 backdrop-blur-md border-t border-border">
      {/* Vision CTA Section */}
      ...
      <div className="border-t border-border bg-background/30 backdrop-blur-md">
