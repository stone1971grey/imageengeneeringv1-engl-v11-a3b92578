    ...
    <div ref={searchRef} className="relative">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-10 w-32 bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:bg-white focus:text-black focus:placeholder:text-muted-foreground"
        />
        {query && (
          <Button
            variant="ghost"
