...
const RichTextEditor = ({ content, onChange }: RichTextEditorProps) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-lg max-w-none focus:outline-none min-h-[400px] p-4 border border-gray-300 rounded-md bg-white prose-headings:font-bold prose-headings:text-gray-900 prose-h2:text-3xl prose-h2:mt-8 prose-h2:mb-6 prose-h2:border-b-2 prose-h2:border-[#f9dc24] prose-h2:pb-3 prose-h3:text-2xl prose-h3:mt-6 prose-h3:mb-4 prose-h3:border-l-4 prose-h3:border-[#f9dc24] prose-h3:pl-4 prose-a:text-blue-600 prose-a:underline hover:prose-a:text-blue-800 prose-p:text-gray-700 prose-p:my-3 prose-strong:text-gray-900 prose-strong:font-bold whitespace-pre-wrap',
      },
    },
  });
