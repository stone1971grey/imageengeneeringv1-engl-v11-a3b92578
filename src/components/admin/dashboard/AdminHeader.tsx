        ...
        <div className="mt-6 space-y-3">
          ...
          >
            ...
            {(isAdmin || (isEditor && (canDraft || canPublish))) && (
              <div className={`flex items-center gap-2 px-3 py-2 rounded-lg bg-[#064e3b] border border-emerald-800 h-10 ${!selectedPage ? 'opacity-50' : ''}`}>
                ...
                <Switch
                  ...
                  onCheckedChange={() => {}}
                  disabled={!selectedPage}
                  className="data-[state=checked]:bg-white data-[state=unchecked]:bg-emerald-950 [&>span]:data-[state=checked]:bg-[#064e3b] [&>span]:data-[state=unchecked]:bg-white"
                />
              </div>
            )}
            ...
            {isAdmin && (
              <div className={`flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-700 border border-emerald-600 h-10 ${!selectedPage ? 'opacity-50' : ''}`}>
                <MonitorSmartphone className="h-5 w-5 text-white flex-shrink-0" />
                <span className="text-base font-medium text-white whitespace-nowrap">Frontend Editing</span>
                <Switch
                ...
                <div className="w-7 h-7 flex-shrink-0 flex items-center justify-center">
                  {pageInfo?.frontendEditingEnabled && selectedPage ? (
                    <Button
                      size="sm"
                      variant="ghost"
                      className="h-7 w-7 p-0 text-white hover:text-emerald-100 hover:bg-emerald-600"
                      onClick={() => {
