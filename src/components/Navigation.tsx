        ...
        <div className="2xl:hidden relative">
          {isOpen && (
            <>
              ...
              {/* Mobile Menu */}
              <div className="absolute top-full right-0 w-full max-w-[800px] bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-[18px] max-h-[calc(100vh-150px)] overflow-y-auto">
                {/* Navigation content */}
