                ...
                <nav className="px-6 py-4">
                  <Accordion type="single" collapsible className="space-y-0">
                    ...
                    <AccordionItem value="solutions" className="border-none">
                       <AccordionTrigger className="px-4 py-4 text-lg font-medium text-gray-900 hover:no-underline bg-gray-100 rounded-lg mx-2 mb-2 data-[state=open]:bg-gray-800 data-[state=open]:text-white">
                          Your Solution
                        </AccordionTrigger>
